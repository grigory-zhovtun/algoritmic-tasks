...
const dir = dirReduc(["NORTH", "SOUTH", "SOUTH", "EAST", "SOUTH", "WEST", "NORTH", "WEST"]);
console.log(dir);
...
You can immediatly see that going "NORTH" and immediately "SOUTH" is not reasonable, better stay
 to the same place! So the task is to give to the man a simplified version of the plan. A better 
